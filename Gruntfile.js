// Generated on 2014-08-27 using generator-webapp 0.4.4
'use strict';
            ...
            server: {
                options: {
                    ...
                    processName: function(filepath) {
                        var split = filepath.replace('.hbs', '').split('/'),
                            templateFileName = split[split.length - 1];
            ...
            dist: {
                options: {
                    ...
                    processContent: function(content) {
                        return content.replace(/\s{2,}/g, ' ').replace(new RegExp( '\\>[\n\t ]+\\<' , 'g' ) , '><');
                    }
                },
                files: {
